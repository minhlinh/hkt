...
function myIP(){/*var ajax=$.ajax('http://jsonip.com')*/return 0;}
var html_loading='<div id="loading"><img src="http://chuyende.phongkhamngoquyen.com/image_all/loading/loading.gif"><p>Phòng khám sản phụ khoa - nam khoa</p><p>chất lượng cao 36 Ngô Quyền</p></div>';var html_success='<div id="success"><img src="http://chuyende.phongkhamngoquyen.com/image_all/success/success.png"><p>Gửi thành công !</p><p>Chúng tôi sẽ gọi lại cho bạn sau ít phút</p></div>';
...
$.fn.d_contact = function(options) {
    ...
    var html_loading = '<div id="loading"><img src="http://chuyende.phongkhamngoquyen.com/image_all/loading/loading.gif"><p>Trung Tâm Y Tế Quận Hoàn Kiếm, Hà Nội</p><p>Phòng khám sản phụ khoa - nam khoa</p><p>chất lượng cao 36 Ngô Quyền</p></div>';
    var html_success = '<div id="success"><img src="http://chuyende.phongkhamngoquyen.com/image_all/success/success.png"><p>Gửi thành công !</p><p>Chúng tôi sẽ gọi lại cho bạn sau ít phút</p></div>';
